  ...
  return (
    ...
    <>
      <div className="testimonialsection">
        <img src={data?.img} alt="tesmonial client" />
        <div className="flex flex-col testimonialsection-container">
          <p className="testimonialsection-container-title">{data?.title}</p>
          <p className="testimonialsection-container-content">
            {data?.content}
          </p>
          <p className="testimonialsection-container-name">{data?.name}</p>
          <p className="testimonialsection-container-designation">
            {data?.designation}
          </p>
        </div>
      </div>
